...
export default function ContactForm({ contact, onSuccess }: ContactFormProps) {
  ...
  const roleOptions = [
    ...
    { value: "strategic_relations_director", label: "Strategic Relations Director" },
  ...
  const form = useForm<InsertContact>({
    ...
    defaultValues: contact ? {
      ...
      govIdExpiration: contact.govIdExpiration || "",
      ...
      spouseGovIdExpiration: contact.spouseGovIdExpiration || "",
      spouseDateOfBirth: contact.spouseDateOfBirth || "",
      spouseDateOfDeath: contact.spouseDateOfDeath || "",
      ...
      businessAddressZip: contact.businessAddressZip || "",
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <CardHeader className="text-center">
              <CardTitle className="text-lg">Strategic Partner, Team Member, or Trusted Professional</CardTitle>
              <CardDescription>
